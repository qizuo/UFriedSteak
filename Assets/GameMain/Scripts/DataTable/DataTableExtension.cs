...
namespace StarForce
{
    public static class DataTableExtension
    {
        ...
        {
            Debug.Log("haha.."+dataTableName+" "+dataTableAssetName);
            ...
            string name = splitedNames.Length > 1 ? splitedNames[1] : splitedNames[0];
            Debug.Log(dataTableComponent);
            Debug.Log(dataRowType);
            Debug.Log(name);
