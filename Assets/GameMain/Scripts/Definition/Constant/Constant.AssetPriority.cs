...
namespace StarForce
{
    public static partial class Constant
    {
        ...
        public static class AssetPriority
        {
            ...
            public const int MonsterSkillPrefab = 80;
            public const int FlySpiritPrefab = 80;
            public const int FountainPrefab = 80;
            public const int HeroPrefab = 80;
            public const int MonsterPrefab = 80;
            public const int ScenePrefab = 80;
            public const int MonsterStancePrefab = 80;
        }
    }
}
