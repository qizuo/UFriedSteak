...
namespace StarForce
{
    public class ProcedurePreload
    {
        ...
        protected void OnLeave(ProcedureOwner procedureOwner, bool isShutdown)
        {
        ...
        //     ChangeState<Game.ProcedureGameMain>(procedureOwner);
        // }
